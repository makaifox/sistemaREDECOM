...
<div class="container-fluid  justify-content-center header-pagina">
        ...
        <div class="container-adm">
            <div class="container-titulo">
                <h1>Editar Métricas de Dezembro</h1>
            </div>
                ...
                <div class="col-xl-12 col-md-12">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="dezembro-action/dezembro-requerimentos-action.php" class="dezembro-requerimentos">
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">                           
                            ...
                            <form method="POST" action="dezembro-action/dezembro-imprensa-action.php" class="dezembro-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h4>Imprensa</h4>           
                                </div>                
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="dezembro-action/dezembro-design-action.php" class="dezembro-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="dezembro-action/dezembro-fotografia-action.php" class="dezembro-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">                                    
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="dezembro-action/dezembro-social-action.php" class="dezembro-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">                                    
