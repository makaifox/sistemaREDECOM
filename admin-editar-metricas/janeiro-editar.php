...
<div class="container-fluid  justify-content-center header-pagina">
        ...
        <div class="container-adm">
            <div class="container-titulo">
                <h1>Editar Métricas de Janeiro</h1>
            </div>
                ...
                <div class="col-xl-12 col-md-12">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="janeiro-action/janeiro-requerimentos-action.php" class="janeiro-requerimentos">
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">                           
                            ...
                            <form method="POST" action="janeiro-action/janeiro-imprensa-action.php" class="janeiro-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h4>Imprensa</h4>           
                                </div>                
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="janeiro-action/janeiro-design-action.php" class="janeiro-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="janeiro-action/janeiro-fotografia-action.php" class="janeiro-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">                                    
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="janeiro-action/janeiro-social-action.php" class="janeiro-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">                                    
