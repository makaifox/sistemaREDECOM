...
<div class="container-fluid  justify-content-center header-pagina">
        ...
        <div class="container-adm">
            <div class="container-titulo">
                <h1>Editar Métricas de Agosto</h1>
            </div>
                ...
                <div class="col-xl-12 col-md-12">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="agosto-action/agosto-requerimentos-action.php" class="agosto-requerimentos">
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">                           
                            ...
                            <form method="POST" action="agosto-action/agosto-imprensa-action.php" class="agosto-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h4>Imprensa</h4>           
                                </div>                
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="agosto-action/agosto-design-action.php" class="agosto-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="agosto-action/agosto-fotografia-action.php" class="agosto-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">                                    
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="agosto-action/agosto-social-action.php" class="agosto-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">                                    
