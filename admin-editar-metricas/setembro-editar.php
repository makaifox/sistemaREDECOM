...
<div class="container-fluid  justify-content-center header-pagina">
        ...
        <div class="container-adm">
            <div class="container-titulo">
                <h1>Editar Métricas de Setembro</h1>
            </div>
                ...
                <div class="col-xl-12 col-md-12">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="setembro-action/setembro-requerimentos-action.php" class="setembro-requerimentos">
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">                           
                            ...
                            <form method="POST" action="setembro-action/setembro-imprensa-action.php" class="setembro-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h4>Imprensa</h4>           
                                </div>                
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="setembro-action/setembro-design-action.php" class="setembro-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="setembro-action/setembro-fotografia-action.php" class="setembro-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">                                    
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="setembro-action/setembro-social-action.php" class="setembro-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">                                    
