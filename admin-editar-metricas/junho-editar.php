...
<div class="container-fluid  justify-content-center header-pagina">
        ...
        <div class="container-adm">
            <div class="container-titulo">
                <h1>Editar Métricas de Junho</h1>
            </div>
                ...
                <div class="col-xl-12 col-md-12">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="junho-action/junho-requerimentos-action.php" class="junho-requerimentos">
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">                           
                            ...
                            <form method="POST" action="junho-action/junho-imprensa-action.php" class="junho-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h4>Imprensa</h4>           
                                </div>                
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="junho-action/junho-design-action.php" class="junho-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="junho-action/junho-fotografia-action.php" class="junho-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">                                    
                ...
                <div class="col-xl-3 col-md-3">
                    <div class="card white-box  mb-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="junho-action/junho-social-action.php" class="junho-demandas">
                                <div class="card-header d-flex align-items-center justify-content-between">                                    
